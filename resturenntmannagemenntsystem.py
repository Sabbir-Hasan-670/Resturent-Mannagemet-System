...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By Group 3 ",bd=2,relief=SUNKEN)
...
lblburger = Label(f1, font=( 'aria' ,16, 'bold' ),text="Combo Iteam ",fg="steel blue",bd=10,anchor='w')
...
def price():
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Combo Iteam", fg="steel blue", anchor=W)
